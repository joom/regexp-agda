...
\acmConference[TyDe '19]{Proceedings of the 4th ACM SIGPLAN International Workshop on Type-Driven Development}{August 2019}{Berlin, Germany}
\acmBooktitle{Proceedings of the 4th ACM SIGPLAN International Workshop on Type-Driven Development (TyDe '19), August 2019, Berlin, Germany}
...
\title{Intrinsic Verification of a Regular Expression Matcher}

\author{Joomy Korkut}
\authornote{The first and second authors were at Wesleyan University when this work was done in 2015-2016.}
...
\renewcommand{\shortauthors}{Korkut, Trifunovski and Licata}
...
\keywords{Dependent types, regular expressions, continuation passing style}
